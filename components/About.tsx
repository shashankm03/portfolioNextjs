...
export default function About() {
  return (
    <div className="w-full bg-[#2a2a2a] p-6 rounded-xl shadow">
      ...
      <p className="mb-4">
        I am Shashank, a passionate Fullstack Developer with strong expertise in building scalable web applications. I specialize in both frontend technologies like React, Next.js and backend tools like Node.js, Express, and MongoDB.
      </p>
      <p className="mb-4">
